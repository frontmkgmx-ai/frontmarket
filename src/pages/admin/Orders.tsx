  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 bg-indigo-50 border border-indigo-100 text-indigo-700 px-3 py-1.5 rounded-lg text-xs font-semibold self-start sm:self-auto">
      ...
      {loading ? (
        <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
          ...
          <p className="text-sm text-slate-500 mt-3">Carregando pedidos em tempo real...</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                  ...
                  return (
                    <tr key={order.id} className="hover:bg-slate-50/70 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="font-medium text-slate-900">{order.customer?.name || 'Cliente'}</div>
          ...
          {/* Cards em Mobile / Tablets Pequenos */}
            ...
            {filteredOrders.map((order) => {
              ...
              return (
                <div key={order.id} className="p-4 space-y-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-slate-900">{order.customer?.name || 'Cliente'}</div>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white p-3 rounded-lg border border-slate-200">
                    <span className="text-xs text-slate-400 block">CPF / Documento</span>
                    <div className="flex items-center gap-1 text-slate-800">
              ...
              {selectedOrder.shippingAddress && (
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Endereço de Entrega</h4>
                  <div className="bg-white p-3.5 rounded-lg border border-slate-200 text-sm flex items-start gap-2.5">
              ...
              {/* Itens do Pedido */}
              <div>
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Produtos Comprados</h4>
