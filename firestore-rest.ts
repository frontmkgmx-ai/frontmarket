...
let DATABASE_ID = process.env.VITE_FIREBASE_DATABASE_ID || 'ai-studio-f452ed5b-7861-4365-a109-42e00eede901';
if (DATABASE_ID.startsWith('http')) {
  DATABASE_ID = 'ai-studio-f452ed5b-7861-4365-a109-42e00eede901';
}
